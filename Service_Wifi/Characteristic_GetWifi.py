...
class Characteristic_GetWifi(Characteristic):
    ...
    def onReadRequest(self, offset, callback):
        print('Characteristic_GetWifi - %s - onReadRequest: value = %s' % (self['uuid'], [self._value.decode()]))
        print('Characteristic_GetWifi - %s - onReadRequest: value = %s' % (self['uuid'], [hex(c) for c in self._value]))
        print('\n')
